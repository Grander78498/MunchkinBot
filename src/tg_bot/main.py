    ...
    match call.data:
        case "tru":
            await call.message.reply(
                f"Тарифы!!!! {get_exchange_rate(Currencies.USD)} ₽"
            )
        case "Ursula":
            await call.message.reply(
                f"Геи негры пидарасы!!!! {get_exchange_rate(Currencies.EUR)} ₽"
            )
        case "XI":
            await call.message.reply(
                f"Тайвань - Китай!!!! {get_exchange_rate(Currencies.CNY)} ₽"
            )
        case "Bel":
            await call.message.reply(
                f"Бульба!!!! {get_exchange_rate(Currencies.BYN)} ₽"
            )
        case "OAE":
            await call.message.reply(
                f"Деньги, тачки, админки!!!! {get_exchange_rate(Currencies.AED)} ₽"
            )
        case "SGD":
            await call.message.reply(
                f"Кораблики!!!! {get_exchange_rate(Currencies.SGD)} ₽"
            )
