...
def upgrade() -> None:
    ...
    sa.Enum('DOOR_DECK', 'TREASURE_DECK', 'DOOR_DISCARD', 'TREASURE_DISCARD', 'PLAYER', name='sourcetype').create(op.get_bind())
    op.create_table('gamecard',
    ...
    sa.Column('source_type', postgresql.ENUM('DOOR_DECK', 'TREASURE_DECK', 'DOOR_DISCARD', 'TREASURE_DISCARD', 'PLAYER', name='sourcetype', create_type=False), nullable=False),
    ...
    sa.Column('item_type', postgresql.ENUM('HEADGEAR', 'ARMOR', 'FOOTGEAR', 'HAND', name='itemtype', create_type=False), nullable=True),
    ...
    sa.ForeignKeyConstraint(['game_card_id'], ['gamecard.id'], name=op.f('fk_gameitem_game_card_id_gamecard')),
    sa.ForeignKeyConstraint(['original_item_id'], ['item.card_id'], name=op.f('fk_gameitem_original_item_id_item')),
    ...
    op.create_table('munchkincard',
    sa.Column('munchkin_id', sa.Integer(), nullable=False),
    sa.Column('card_id', sa.Integer(), nullable=False),
    sa.Column('in_game', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['card_id'], ['gamecard.id'], name=op.f('fk_munchkincard_card_id_gamecard')),
    sa.ForeignKeyConstraint(['munchkin_id'], ['munchkin.id'], name=op.f('fk_munchkincard_munchkin_id_munchkin')),
    sa.PrimaryKeyConstraint('munchkin_id', 'card_id', name=op.f('pk_munchkincard'))
    )
    op.create_table('munchkinitem',
    sa.Column('munchkin_id', sa.Integer(), nullable=False),
    sa.Column('item_id', sa.Integer(), nullable=False),
    sa.Column('in_game', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['item_id'], ['gameitem.game_card_id'], name=op.f('fk_munchkinitem_item_id_gameitem')),
    sa.ForeignKeyConstraint(['munchkin_id'], ['munchkin.id'], name=op.f('fk_munchkinitem_munchkin_id_munchkin')),
    ...
    op.sync_enum_values(
        ...
        affected_columns=[TableReference(table_schema='public', table_name='gameitem', column_name='item_type'), TableReference(table_schema='public', table_name='item', column_name='item_type')],
...
def downgrade() -> None:
    ...
    op.sync_enum_values(
        enum_schema='public',
        enum_name='itemtype',
        new_values=['HEADGEAR', 'ARMOR', 'FOOTGEAR', 'ONE_HAND', 'TWO_HAND', 'THREE_HAND', 'MINUS_HAND'],
        affected_columns=[TableReference(table_schema='public', table_name='gameitem', column_name='item_type'), TableReference(table_schema='public', table_name='item', column_name='item_type')],
        enum_values_to_rename=[],
    )
    ...
    sa.Enum('DOOR_DECK', 'TREASURE_DECK', 'DOOR_DISCARD', 'TREASURE_DISCARD', 'PLAYER', name='sourcetype').drop(op.get_bind())
    # ### end Alembic commands ###
