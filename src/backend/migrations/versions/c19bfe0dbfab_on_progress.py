...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['card_id'], ['card.id'],
                                name=op.f('fk_item_card_id_card')),
    ...
    op.create_table(
        'combat', sa.Column('id', sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(['game_id'], ['game.id'],
                                name=op.f('fk_combat_game_id_game')),
        sa.PrimaryKeyConstraint('id', name=op.f('pk_combat')))
    op.create_table(
        'munchkincombat', sa.Column('munchkin_id',
                                    sa.Integer(),
                                    nullable=False),
        ...
        sa.PrimaryKeyConstraint('munchkin_id',
                                'combat_id',
                                name=op.f('pk_munchkincombat')))
    op.alter_column('munchkin',
                    'gender',
                    existing_type=postgresql.ENUM('MALE',
                                                  'FEMALE',
                                                  name='gender'),
                    nullable=False)
    op.alter_column('munchkin',
    ...
    op.alter_column('munchkin',
                    ...
                    existing_type=sa.SMALLINT(),
                    nullable=False)
    op.create_unique_constraint(op.f('uq_munchkin_user_id'), 'munchkin',
                                ['user_id', 'game_id'])
    op.alter_column('turn',
                    'turn_type',
                    existing_type=postgresql.ENUM('KICK_DOOR',
                                                  'LOOK_TROUBLE',
                                                  'LOOT_ROOM',
                                                  'CHARITY',
                                                  'COMBAT',
