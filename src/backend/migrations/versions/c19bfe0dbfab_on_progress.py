...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["card_id"], ["card.id"], name=op.f("fk_item_card_id_card")),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["game_id"], ["game.id"], name=op.f("fk_combat_game_id_game")),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("munchkin_id", "combat_id", name=op.f("pk_munchkincombat")),
    )
    op.alter_column(
        "munchkin",
        "gender",
    ...
    op.alter_column("munchkin", "number", existing_type=sa.SMALLINT(), nullable=False)
    op.alter_column("munchkin", "level", existing_type=sa.SMALLINT(), nullable=False)
    op.alter_column("munchkin", "strength", existing_type=sa.SMALLINT(), nullable=False)
    op.alter_column("munchkin", "luck", existing_type=sa.SMALLINT(), nullable=False)
    op.alter_column("munchkin", "runaway_bonus", existing_type=sa.SMALLINT(), nullable=False)
    op.create_unique_constraint(op.f("uq_munchkin_user_id"), "munchkin", ["user_id", "game_id"])
    op.alter_column(
        "turn",
        "turn_type",
...
def downgrade() -> None:
    ...
    op.alter_column("munchkin", "runaway_bonus", existing_type=sa.SMALLINT(), nullable=True)
    op.alter_column("munchkin", "luck", existing_type=sa.SMALLINT(), nullable=True)
    op.alter_column("munchkin", "strength", existing_type=sa.SMALLINT(), nullable=True)
    op.alter_column("munchkin", "level", existing_type=sa.SMALLINT(), nullable=True)
    op.alter_column("munchkin", "number", existing_type=sa.SMALLINT(), nullable=True)
    op.alter_column(
        "munchkin",
        "gender",
        existing_type=postgresql.ENUM("MALE", "FEMALE", name="gender"),
