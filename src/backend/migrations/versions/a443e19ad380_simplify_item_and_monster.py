...
def upgrade() -> None:
    ...
    sa.Column('monster_type', postgresql.ENUM('UNDEAD', name='monstertype', create_type=False), nullable=True),
    ...
    op.alter_column('card', 'description',
    ...
    op.alter_column('gameitem', 'runaway_bonus',
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('item', sa.Column('image_path', sa.VARCHAR(length=64), autoincrement=False, nullable=False))
    op.add_column('item', sa.Column('card_type', postgresql.ENUM('DOOR', 'TREASURE', name='cardtype', create_type=False), autoincrement=False, nullable=False))
    op.add_column('item', sa.Column('name', sa.VARCHAR(length=64), autoincrement=False, nullable=False))
    op.add_column('item', sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True))
    ...
    op.add_column('gameitem', sa.Column('name', sa.VARCHAR(length=64), autoincrement=False, nullable=False))
    op.add_column('gameitem', sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True))
    op.add_column('gameitem', sa.Column('card_type', postgresql.ENUM('DOOR', 'TREASURE', name='cardtype', create_type=False), autoincrement=False, nullable=False))
    op.add_column('gameitem', sa.Column('runway_bonus', sa.SMALLINT(), autoincrement=False, nullable=True))
    op.add_column('gameitem', sa.Column('image_path', sa.VARCHAR(length=64), autoincrement=False, nullable=False))
    ...
    op.alter_column('gameitem', 'runaway_bonus',
               ...
               type_=sa.INTEGER(),
               existing_nullable=True)
    op.add_column('gamecard', sa.Column('image_path', sa.VARCHAR(length=64), autoincrement=False, nullable=False))
    op.add_column('gamecard', sa.Column('card_type', postgresql.ENUM('DOOR', 'TREASURE', name='cardtype', create_type=False), autoincrement=False, nullable=False))
    op.add_column('gamecard', sa.Column('name', sa.VARCHAR(length=64), autoincrement=False, nullable=False))
    op.add_column('gamecard', sa.Column('description', sa.VARCHAR(), autoincrement=False, nullable=False))
