...
def upgrade() -> None:
    ...
    op.create_table(
        'monster', sa.Column('level', sa.SmallInteger(), nullable=False),
        ...
        sa.ForeignKeyConstraint(['card_id'], ['card.id'],
                                name=op.f('fk_monster_card_id_card')),
        sa.PrimaryKeyConstraint('card_id', name=op.f('pk_monster')))
    op.alter_column('card',
                    'description',
...
def downgrade() -> None:
    ...
    op.create_unique_constraint('uq_gameitem_image_path', 'gameitem',
                                ['image_path'])
    op.create_unique_constraint('uq_gameitem_description', 'gameitem',
                                ['description'])
    op.alter_column('gameitem',
                    'runaway_bonus',
    ...
    op.create_unique_constraint('uq_gamecard_image_path', 'gamecard',
                                ['image_path'])
    op.alter_column('card',
                    'description',
                    existing_type=sa.TEXT(),
