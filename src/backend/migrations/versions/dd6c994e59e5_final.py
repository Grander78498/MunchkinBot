...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["action_id"], ["action.id"], name=op.f("fk_cardaction_action_id_action")
        ),
        sa.ForeignKeyConstraint(
            ["card_id"], ["card.id"], name=op.f("fk_cardaction_card_id_card")
        ),
    ...
    op.create_table(
        ...
        sa.Column("action_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["action_id"], ["action.id"], name=op.f("fk_cardstransfer_action_id_action")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["type_id"],
            ["possibleconditiontype.id"],
            name=op.f("fk_possibleconditionfield_type_id_possibleconditiontype"),
        ),
    ...
    op.create_table(
        ...
        sa.Column("action_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["action_id"], ["action.id"], name=op.f("fk_statschange_action_id_action")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["field_id"],
            ["possibleconditionfield.id"],
            name=op.f("fk_possibleconditionvalue_field_id_possibleconditionfield"),
        ),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "action_id", "munchkin_id", name=op.f("pk_actionmunchkin")
        ),
    )
    op.create_table(
        "condition",
        ...
        sa.Column(
            "equal_type",
            postgresql.ENUM(
                "LT", "LE", "EQ", "NQ", "GE", "GT", name="equaltype", create_type=False
            ),
            nullable=False,
        ),
        sa.ForeignKeyConstraint(
            ["value_id"],
            ["possibleconditionvalue.id"],
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "action_id", "condition_id", name=op.f("pk_actioncondition")
        ),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["cards_transfer_id"],
            ["cardstransfer.action_id"],
            name=op.f("fk_cardstransfercondition_cards_transfer_id_cardstransfer"),
        ),
        sa.ForeignKeyConstraint(
            ["condition_id"],
            ["condition.id"],
        ...
        sa.PrimaryKeyConstraint(
            "cards_transfer_id", "condition_id", name=op.f("pk_cardstransfercondition")
        ),
    )
    op.create_table(
        "itemcondition",
        ...
        sa.ForeignKeyConstraint(
            ["item_id"], ["item.card_id"], name=op.f("fk_itemcondition_item_id_item")
        ),
        sa.PrimaryKeyConstraint(
            "item_id", "condition_id", name=op.f("pk_itemcondition")
        ),
    )
    op.sync_enum_values(
        enum_schema="public",
        ...
        affected_columns=[
            TableReference(
                table_schema="public", table_name="munchkin", column_name="gender"
            )
        ],
