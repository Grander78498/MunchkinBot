...
class MunchkinCard(CustomSQLModel, table=True):
    ...
    munchkin_id: int | None = Field(default=None, primary_key=True, foreign_key="munchkin.id")
    card_id: int | None = Field(default=None, primary_key=True, foreign_key="gamecard.id")
    in_game: bool
...
class MunchkinItem(CustomSQLModel, table=True):
    ...
    munchkin_id: int | None = Field(default=None, primary_key=True, foreign_key="munchkin.id")
    item_id: int | None = Field(default=None, primary_key=True, foreign_key="gameitem.game_card_id")
    in_game: bool
...
class MonsterCombat(CustomSQLModel, table=True):
    ...
    monster_id: int | None = Field(default=None, primary_key=True, foreign_key="monster.card_id")
    combat_id: int | None = Field(default=None, primary_key=True, foreign_key="combat.id")
...
class MunchkinStats(CustomSQLModel, table=True):
    ...
    munchkin_id: int | None = Field(default=None, primary_key=True, foreign_key="munchkin.id")
    stats_id: int | None = Field(default=None, primary_key=True, foreign_key="stats.card_id")


class CardAction(CustomSQLModel, table=True):
    """Связь между карточками и действиями."""

    action_id: int | None = Field(default=None, primary_key=True, foreign_key="action.id")
...
class ActionCondition(CustomSQLModel, table=True):
    ...
    action_id: int | None = Field(default=None, primary_key=True, foreign_key="action.id")
    condition_id: int | None = Field(default=None, primary_key=True, foreign_key="condition.id")
...
class ItemCondition(CustomSQLModel, table=True):
    ...
    item_id: int | None = Field(default=None, primary_key=True, foreign_key="item.card_id")
    condition_id: int | None = Field(default=None, primary_key=True, foreign_key="condition.id")
